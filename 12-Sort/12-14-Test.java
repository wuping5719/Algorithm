...
public class Test {
	...
	System.out.println("冒泡排序执行时间： "
		+ (bubbleSortEndTime - bubbleSortStartTime) + "ns");
	...
	System.out.println("选择排序执行时间： "
		+ (selectSortEndTime - selectSortStartTime) + "ns");
	...
	System.out.println("插入排序执行时间： "
		+ (insertSortEndTime - insertSortStartTime) + "ns");
	...
	System.out.println("快速排序执行时间： "
		+ (quickSortEndTime - quickSortStartTime) + "ns");
	...
	System.out.println("堆排序执行时间： " + (heapSortEndTime - heapSortStartTime)
		+ "ns");
	...
	System.out.println("希尔排序执行时间： "
		+ (shellSortEndTime - shellSortStartTime) + "ns");
	...
	System.out.println("归并排序执行时间： "
		+ (mergeSortEndTime - mergeSortStartTime) + "ns");
	...
	System.out.println("计数排序执行时间： "
		+ (countSortEndTime - countSortStartTime) + "ns");
	...
	System.out.println("桶排序执行时间： "
		+ (bucketSortEndTime - bucketSortStartTime) + "ns");
	...
	System.out.println("基数排序执行时间： "
		+ (radixSortEndTime - radixSortStartTime) + "ns");
	...
	System.out.println("折半插入排序执行时间： "
		+ (binaiSortEndTime - binaiSortStartTime) + "ns");
	...
	System.out.println("2路插入排序执行时间： " + (twoSortEndTime - twoSortStartTime)
		+ "ns");
	...
	System.out.println("树形选择排序执行时间： "
		+ (treeSelectSortEndTime - treeSelectSortStartTime) + "ns");
	...
	CombSort.combSort(arrayA);
	long combSortEndTime = System.nanoTime(); // 获取结束时间
	System.out.println("梳排序执行时间： "
		+ (combSortEndTime - combSortStartTime) + "ns");
	System.out.println("梳排序后的整形数组：");
	for (int i = 0; i < arrayA.length; i++) {
	    System.out.print(arrayA[i] + " ");
	}
	System.out.println();
